...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
        ...
        /**
         * Creates a dependency provider for fontAwesome (br.com.devsrsouza.compose.icons:font-awesome)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getFontAwesome() {
            return create("fontAwesome");
    }
        ...
        /**
         * Creates a dependency provider for jsystemThemeDetector (com.github.Dansoftowner:jSystemThemeDetector)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getJsystemThemeDetector() {
            return create("jsystemThemeDetector");
    }
        ...
        /**
         * Creates a dependency provider for mpfilepicker (com.darkrockstudios:mpfilepicker)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getMpfilepicker() {
            return create("mpfilepicker");
    }
        ...
        /**
         * Creates a dependency provider for notify (com.dorkbox:Notify)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getNotify() {
            return create("notify");
    }

        /**
         * Creates a dependency provider for richEditorCompose (com.mohamedrejeb.richeditor:richeditor-compose)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getRichEditorCompose() {
            return create("richEditorCompose");
    }
    ...
    public static class ComposeMaterialIconsLibraryAccessors extends SubDependencyFactory {
        ...
        public ComposeMaterialIconsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for extended (org.jetbrains.compose.material:material-icons-extended)
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: fontAwesome (1.1.0)
            ...
            /**
             * Returns the version associated to this alias: jsoup (1.17.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: jsystemThemeDetector (3.6)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getJsystemThemeDetector() { return getVersion("jsystemThemeDetector"); }
            ...
            /**
             * Returns the version associated to this alias: materialKolor (1.3.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: mpfilepicker (3.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getMpfilepicker() { return getVersion("mpfilepicker"); }
            ...
            /**
             * Returns the version associated to this alias: notify (4.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getNotify() { return getVersion("notify"); }

            /**
             * Returns the version associated to this alias: precompose (1.5.10)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: richEditor (1.0.0-rc01)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
